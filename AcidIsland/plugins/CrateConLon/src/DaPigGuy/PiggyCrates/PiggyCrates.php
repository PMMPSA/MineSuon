...
class PiggyCrates extends PluginBase
{
    ...
    public function onEnable(): void
    {
        ...
        $this->getServer()->getCommandMap()->register("piggycrates", new CrateCommand($this, "taoruong", "Tạo rương quay may măn"));
        $this->getServer()->getCommandMap()->register("piggycrates", new KeyCommand($this, "nhankey", "Lấy key"));
        $this->getServer()->getCommandMap()->register("piggycrates", new KeyAllCommand($this, "laykeyall", "Tặng key cho mọi người"));
