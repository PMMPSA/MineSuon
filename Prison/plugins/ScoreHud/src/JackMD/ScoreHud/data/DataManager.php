...
class DataManager{
 ...
 //        	$m =$economyAPI->myMoney($player); 
 //        	    $money = $m;
 //        	if($m >= 1000){
 //        	    $money = round($m/1000, 2)."K";
 //         	}
 //           if($m >= 1000000){
 //        	   $xu = $m/1000000;
 //        	   $xu2 = round($xu, 2);
 ...
 //        	}  
	...
	// 	if($CoinAPI instanceof CoinAPI){
 //        	$c =$CoinAPI->myCoin($player); 
 //        	    $Coin = $c;
 //        	if($c >= 1000){
 //        	    $dt = $c/1000;
 //        	    $dt2 = round($dt, 2);
 ...
 //        	}  
	...
	// 	/** @var EconomyAPI $economyAPI */
	// 	$prison = $this->plugin->getServer()->getPluginManager()->getPlugin("LevelPrison");
	// 	 if(!($prison->info->exists(strtolower($player->getName())))){ 
	// 	     return 1;
	// 	 }else{
 //        	$m = $prison->getExp($player); 
 //        	    $money = $m;
 //        	if($m >= 1000){
 //        	    $xu = $m/1000;
 //        	    $xu2 = round($xu, 2);
 ...
 //        	}
	...
	// public function getMaxExp(Player $player){
	// 	/** @var EconomyAPI $economyAPI */
	// 	$prison = $this->plugin->getServer()->getPluginManager()->getPlugin("LevelPrison");
	// 	if(!($prison->info->exists(strtolower($player->getName())))){ 
	// 	     return 1;
	// 	 }else{
 //        	$m = $prison->getExp($player) * 10000; 
 //        	    $money = $m;
 //        	if($m >= 1000){
 //        	    $xu = $m/1000;
 //        	    $xu2 = round($xu, 2);
 ...
 //        	}
	...
	// 	$level = $this->plugin->getServer()->getPluginManager()->getPlugin("LevelPrison");
	// 			 if(!($level->info->exists(strtolower($player->getName())))){ 
	// 	     return 1;
	// 	 }else{
	// 		return $level->getLevel($player);
	// 	 }
	// }
	...
	// 	/** @var PointAPI $pointAPI */
	// 	$level = $this->plugin->getServer()->getPluginManager()->getPlugin("Gem");
	// 		return $level->gem->get($player->getName());
	// }
