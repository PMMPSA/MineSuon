                ...
                switch ($args[0]) {
                    case "help":
                        $help = [
                            ...
                            "§r⨞§l§e /c §f:§c Trò Chuyện Kênh Clan",
                            "§r⨞§l§e /clan top §f:§c Xem Xếp Hạng Clan",
                            "§r⨞§l§e /clan create §f:§c Tạo Một Clan Mới",
                            "§r⨞§l§e /clan delete §f:§c Xoá Clan Của Bạn",
                            "§r⨞§l§e /clan join §f:§c Gửi Yêu Cầu Xin Gia Nhập Clan",
                            "§r⨞§l§e /clan quit §f:§c Thoát Clan Của Bạn",
                            "§r⨞§l§e /clan accept §f:§c Chấp Nhận Lời Mời Vào Clan",
                            "§r⨞§l§e /clan decline §f:§c Từ Chối Lời Mời Vào Clan",
                            "§r⨞§l§e /clan donate §f:§c Cống Hiến Cho Clan",
                            "§r⨞§l§e /clan lookup §f:§c Xem Tù Nhân Thuộc Clan Nào",
                            "§r⨞§l§e /clan requestlist §f:§c Xem Danh Sách Các Thành Viên Xin Vào Clan",
                            "§r⨞§l§e /clan status §f:§c Xem Thông Tin Clan",
                            "§r⨞§l§e /clan invite §f:§c Mời Thêm Tù Nhân Vào Clan",
                            "§r⨞§l§e /clan kick §f:§c Đuổi Thành Viên Khỏi Clan",
                            "§r⨞§l§e /clan motd §f:§c Sửa Khẩu Hiệu Clan",
                            "§r⨞§l§e /clan setrank §f:§c Chỉnh Chức Vụ cho Thành Viên Trong Clan",
                            "§r⨞§l§e /clan levelup §f:§c Nâng Cấp Clan",
                        ];
